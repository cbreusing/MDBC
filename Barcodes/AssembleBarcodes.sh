...
blastn -query ${FILE}_COI.fasta -db /scratch/dbs/blast/bold/bold_blast_2023_05_12 -out blast.${FILE}.COI.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 50 -outfmt 6
...
blastn -query ${FILE}_COI.fasta -db /scratch/dbs/blast/v5/mito -out blast.${FILE}.mito.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 50 -outfmt "6 std stitle staxids"
...
blastn -query ${FILE}_18S.fasta -db /scratch/dbs/blast/v5/nt -out blast.${FILE}.18Snt.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 50 -outfmt "6 std stitle staxids"
...
blastn -query ${FILE}_28S.fasta -db /scratch/dbs/blast/v5/nt -out blast.${FILE}.28Snt.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 50 -outfmt "6 std stitle staxids"
