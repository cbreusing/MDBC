...
blastn -query spades_${FILE}_18S/scaffolds.fasta -db /scratch/nmnh_mdbc/breusingc/databases/SILVA_138.1_SSURef_NR99 -out blast.${FILE}.18S.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 1 -out
fmt "6 std stitle"
...
blastn -query spades_${FILE}_28S/scaffolds.fasta -db /scratch/nmnh_mdbc/breusingc/databases/SILVA_138.1_LSURef_NR99 -out blast.${FILE}.28S.txt -evalue 1e-10 -num_threads ${NSLOTS} -max_target_seqs 1 -ou
tfmt "6 std stitle"
